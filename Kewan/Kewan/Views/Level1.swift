...
//                                        .background(Color.blue)
        ...
        //第一关成功页面
//        .fullScreenCover(isPresented: $gameVM.showSuccessView) {
//            SuccessfulView(
//                gameVM: gameVM,
//                showGameView: $showGameView  // 传递 showGameView 绑定
//            )
//        }
    ...
    private func updateBubble(key: String) {
        ...
        // 减小机扰动
        velocity.x += CGFloat.random(in: -5...5)  // 原来是 -10...10
        velocity.y += CGFloat.random(in: -5...5)  // 原来是 -10...10
        
        // 降低最大速度
        let maxSpeed: CGFloat = 100  // 原来是 200
